...
public class WebSocketUtils {
    ...
    public static void sendMessageTenant(Long sessionKey, String message) {
        Map<Long, WebSocketSession> sessions = WebSocketSessionHolder.getTenantSessions(sessionKey);
        if (sessions != null) {
