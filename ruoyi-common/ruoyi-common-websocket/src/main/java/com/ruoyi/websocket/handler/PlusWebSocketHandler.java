...
public class PlusWebSocketHandler extends AbstractWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) {
        ...
        WebSocketSessionHolder.addSessionTenant(loginUser.getTenantId(), loginUser.getUserId(), session);
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        LoginUser loginUser = (LoginUser) session.getAttributes().get(LOGIN_USER_KEY);
        List<Long> userIds = Arrays.asList(loginUser.getUserId());
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) {
        ...
        WebSocketSessionHolder.removeSessionTenant(loginUser.getTenantId(), loginUser.getUserId());
